    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div class="d-block w-100 event-image"
            ...
            <div class="carousel-item">
                <div class="d-block w-100 event-image"
                    style="background-image:url(https://addresti-storage.s3.amazonaws.com/1610655746292)"
                    alt="Second slide">
                </div>
            ...
            <div class="carousel-item">
                <div class="d-block w-100 event-image"
                    style="background-image:url(https://addresti-storage.s3.amazonaws.com/1610656068918)"
                    alt="Third slide">
                </div>
